...
export class Server extends EventEmitter {
  ...
  constructor(
    options: WithOptional<ServerOptions, "locker"> & { datastore: DataStore }
  ) {
    super();
  ...
  async handle(
    ...
    const onError = async (error: {
      ...
      let body =
        error.body || `${ERRORS.UNKNOWN_ERROR.body}${error.message || ""}\n`;
    ...
    res.setHeader("Upload-Protocol", TUS_RESUMABLE);
    ...
    if (
      ...
      return this.write(
        ...
        res,
        412,
        JSON.stringify({ message: "Upload-Protocol Required" })
      );
    }
